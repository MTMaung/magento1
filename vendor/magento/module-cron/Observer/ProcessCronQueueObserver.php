...
class ProcessCronQueueObserver implements ObserverInterface
{
    ...
    private function setProcessTitle(string $jobCode, string $groupId): void
    {
        ...
        if (strpos($this->originalProcessTitle, " --group=$groupId ") !== false) {
            ...
            if(function_exists('cli_set_process_title'))cli_set_process_title ($this->originalProcessTitle . " # job: $jobCode");
        } else {
            if(function_exists('cli_set_process_title'))cli_set_process_title ($this->originalProcessTitle . " # group: $groupId, job: $jobCode");
        }
    }
